...
;;; COMMENT:
;;; ((null? L) '()) it's better to return a void list here rather than 0.
...
;;; COMMENT:
;;; If there are so many levels of conditions, what about use cond instead of if?
...
;;; COMMENT:
;;; Not quite right. It should keep the increasing order after mergeN.
;;; Think about applying merge2 N-1 times, in each time, merge 2 lists
;;; -4

;;; COMMENT
;;; Missed one question: how many cons operations in terms of the sizes of the
;;; input lists
;;; See instructions
;;; -6
